function ConductanceGauge(placeholderName, configuration)
{
	...
	this.configure = function(configuration)
	{
		...
		this.config.pinkColor 	= configuration.pinkColor || "#e4ddcb";
		this.config.purpleColor = configuration.purpleColor || "#e3d7b5";
		this.config.lPurpleColor = configuration.lPurpleColor || "#e3d2a2";
		this.config.dBlueColor 	= configuration.dBlueColor || "#e4ce8f";
		this.config.blueColor 	= configuration.blueColor || "#e5c877";
		this.config.lBlueColor 	= configuration.lBlueColor || "#e4c15f";
		this.config.blueGreenColor 	= configuration.blueGreenColor || "#e5bb47";
		this.config.greenColor = configuration.greenColor || "#e8b62b";
		this.config.lGreenColor 	= configuration.lGreenColor || "#e5bb47";
		this.config.yellowColor = configuration.yellowColor || "#e4c15f";
		this.config.lOrangeColor = configuration.lOrangeColor || "#e5c877";
		this.config.orangeColor = configuration.orangeColor || "#e4ce8f";
		this.config.redColor 	= configuration.redColor || "#e3d2a2";
		this.config.dRedColor 	= configuration.dRedColor || "#e3d7b5";
